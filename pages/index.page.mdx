...
<Main>
  ...
  <Countdown />
  *Counter Strike 2* the follow up game to the original *Counter Strike: Global Offensive*. This game will have upgraded grenade systems, revamped maps, and possibly RTX support.
</Main>
<Footer />
